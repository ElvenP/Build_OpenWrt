...
# 拉取 主题
git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/lean/luci-theme-argon-py
...
sed -i 's/luci-theme-bootstrap/luci-theme-argon-py/' feeds/luci/collections/luci/Makefile
